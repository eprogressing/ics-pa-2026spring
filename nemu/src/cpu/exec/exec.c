...
opcode_entry opcode_table [512] = {
  ...
  /* 0x8c */	EMPTY, IDEX(lea_M2G, lea), EMPTY, IDEX(gp7_E, gp6),
  ...
  /* 0xac */	EMPTY, EMPTY, IDEXW(mov_E2G, movzx, 1), IDEXW(mov_E2G, movzx, 2),
  /* 0xb0 */	EMPTY, EMPTY, EMPTY, EMPTY,
  /* 0xb4 */	EMPTY, EMPTY, IDEXW(mov_E2G, movsx, 1), IDEXW(mov_E2G, movsx, 2),
